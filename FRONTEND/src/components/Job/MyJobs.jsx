...
const MyJobs = () => {
    ...
    const fetchJobs = async () => {
      try {
        const { data } = await axios.get(
          "https://job-magnet.onrender.com/api/v1/job/getmyjobs",
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(`https://job-magnet.onrender.com/api/v1/job/update/${jobId}`, updatedJob, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const handleDeleteJob = async (jobId) => {
    ...
    await axios
      .delete(`https://job-magnet.onrender.com/api/v1/job/delete/${jobId}`, {
        withCredentials: true,
      })
      .then((res) => {
        toast.success(res.data.message);
...
return (
    ...
    <div className="container">
      ...
      {myJobs.length > 0 ? (
        ...
        <p>
          You have not posted any job or may be you had deleted all of your jobs!
        </p>
      )}
    </div>
  </div>
